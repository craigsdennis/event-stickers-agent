/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: af9cb98338c536561ad32b1f21675e58)
// Runtime types generated with workerd@1.20250428.0 2025-05-03 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		REPLICATE_API_KEY: string;
		HackathonAgent: DurableObjectNamespace<import("./src/index").HackathonAgent>;
		EVENT_STICKERS: R2Bucket;
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		STICKER_CREATOR: Workflow;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REPLICATE_API_KEY">> {}
}
